...
ng = a.directive('plain2SunburstHead', function($compile) {
...
ng = a.directive('plain2SunburstControls', function($compile) {
    function link(scope, element, attr) { }
    return {
        restrict: "E",
        link: link,
...
ng = a.directive('plain2SunburstChart', function($compile) {
